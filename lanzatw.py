...
class Twitter():
    ...
    def sendTweets(self,carrera1,carrera2):
        ...
        tweet_c1 = self.api.update_with_media(f"Like a este tweet para luchar en el bando de {carrera1}", in_reply_to_status_id=tweet.id,filename=self.getFoto(carrera1))
        tweet_c2 = self.api.update_with_media(f"Like a este tweet para luchar en el bando de {carrera2}", in_reply_to_status_id=tweet.id,filename=self.getFoto(carrera2))
